                  ...
                  <Dialog open={showHelpModal} onOpenChange={setShowHelpModal}>
                    ...
                    <DialogContent className="sm:max-w-md">
                      ...
                      <div className="space-y-4">
                        <p className="text-sm text-muted-foreground">
                          Having a tech issue? Send us an email at{' '}
                          <a 
                            href="mailto:aircollab2025@gmail.com" 
                            className="text-primary hover:underline font-medium"
                          >
                            aircollab2025@gmail.com
                          </a>
                          . Please use the subject line to briefly describe the problem (for example: 'Page not loading on Chrome', 'Login Error, Unable to Access Account').
                        </p>
                      </div>
                    </DialogContent>
                  </Dialog>
